...
trait MonadLifter {
    ...
    implicit class MonadLifterExtension[T](val full: T) {

      case class As1[A[_]](implicit m: Monad[A]){
        def run[I](implicit ev: A[I] =:= T): LiftedMonad[A, I] =
          new LiftedMonad[A, I](full.asInstanceOf[A[I]])
      }
      ...
      case class As2[A[_], B[_]](implicit a: Monad[A], b: Monad[B], tb: ComposableMonad[B]){
        type MR[TT] = A[B[TT]]
        def run[I](implicit ev: A[B[I]] =:= T): LiftedMonad[MR, I] =
          new LiftedMonad[MR, I](full.asInstanceOf[A[B[I]]])(Moon[A, B])
      }
      ...
      case class As3[A[_], B[_], C[_]](implicit a: Monad[A], b: Monad[B], tb: ComposableMonad[B], c: Monad[C], tc: ComposableMonad[C]){
        type MR[TT] = A[B[C[TT]]]
        def run[I](implicit ev: A[B[C[I]]] =:= T): LiftedMonad[MR, I] =
          new LiftedMonad[MR, I](full.asInstanceOf[A[B[C[I]]]])(Moon[A, B, C])
      }
      ...
      case class As4[A[_], B[_], C[_], D[_]](implicit a: Monad[A], b: Monad[B], tb: ComposableMonad[B], c: Monad[C], tc: ComposableMonad[C], d: Monad[D], td: ComposableMonad[D]){
        ...
        def run[I](implicit ev: A[B[C[D[I]]]] =:= T): LiftedMonad[MR, I] =
          new LiftedMonad[MR, I](full.asInstanceOf[A[B[C[D[I]]]]])(Moon[A, B, C, D])
      }
